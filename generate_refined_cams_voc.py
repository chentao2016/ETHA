...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='./Datasets_HSN/VOC2012/JPEGImages')
    parser.add_argument('--split_file', type=str, default='./pytorch_grad_cam_refined/voc12/train.txt')
    parser.add_argument('--cam_out_dir', type=str, default='./Datasets_HSN/Refined_CAM_VOC')
