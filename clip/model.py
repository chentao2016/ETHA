...
class Transformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, extract_layers=None):
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, H, W):
        ...
        x, attn_weight, activations = self.transformer(x, self.extract_layers)
        '''
        ...
        return x, attn_weight, activations
