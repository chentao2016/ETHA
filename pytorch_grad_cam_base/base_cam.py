...
import torch
import ttach as tta
from pytorch_grad_cam_base.activations_and_gradients import ActivationsAndGradients
...
class BaseCAM:
    ...
    def get_cam_image(self,
        ...
        if grads.ndim != 4:
            ...
            activations = activations[1:].transpose(1, 2, 0)
            activations = activations.reshape((activations.shape[0], activations.shape[1], w, w))
