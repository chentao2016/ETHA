...
from pytorch_grad_cam_base import GradCAM
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--traincampath', type=str, default='./Datasets_HSN/Base_CAM_VOC_Train/')
    parser.add_argument('--valcampath', type=str, default='./Datasets_HSN/Base_CAM_VOC_Val/')
    ...
    if not os.path.exists(args.traincampath):
        os.makedirs(args.traincampath)
    if not os.path.exists(args.valcampath):
        os.makedirs(args.valcampath)
