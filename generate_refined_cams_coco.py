# -*- coding:UTF-8 -*-
from pytorch_grad_cam_refined import GradCAM
import torch
import clip
...
from pytorch_grad_cam_refined.utils.image import scale_cam_image
...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='./Datasets_HSN/COCO2014/JPEGImages/train2014')
    parser.add_argument('--split_file', type=str, default='./pytorch_grad_cam_refined/coco14/train.txt')
    parser.add_argument('--cam_out_dir', type=str, default='./Datasets_HSN/Refined_CAM_COCO')
    parser.add_argument('--model', type=str, default='./pretrain/ViT-B-16.pt')
